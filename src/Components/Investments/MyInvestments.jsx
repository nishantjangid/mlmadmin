...
import { AuthContext } from '../../Context/AuthContext';
    ...
    function MyInvestments() {
        ...
        const invest= async () => {
            ...
            handleCloseDialog();
            try{
                let result = await investment({userId:wallet,amount});                        
                let data = result;    
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="welcome_heading">Investment New</h1>
                                </div>
                                <div className="col-sm-6">
                                        ...
                                        <div className="card-body" style={{ backgroundColor: '#000000' }}>
                                            ...
                                            <form role="form" action="https://hammertradex.com/Fund-Transfer-insert" id="mypassform" method="post" encType="multipart/form-data">
                                                ...
                                                <div className="form-row">
                                                    ...
                                                    <div className="col-md-12 mb-3 ">
                                                        <label htmlFor="validationCustomUsername" className="text-white">User ID</label>
                                                        <div className="position-relative has-icon-right">
                                                            <input style={{ background: 'white' }} type="text" id="username" className="form-control input-shadow input_box" placeholder="Enter User Id" name="username" required="reqired" autoComplete="none" onChange={(e) => {
                                                                setMessage("");
                                                    ...
                                                    <div className="col-md-12 mb-3">
                                                        ...
                                                        <input style={{ background: 'white', padding: '20px' }} type="number" className="form-control input_box" name="amount" id="validationCustom02" value={amount} placeholder="Amount" required onChange={(e) => {
                                                            setMessage("");
